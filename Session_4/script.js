...
// Load sound effects
const flapSound = new Audio("sounds/bonus.mp3"); //todo: change later
const scoreSound = new Audio("sounds/bonus.mp3");  //todo: change later
const hitSound = new Audio("sounds/bonus.mp3");  //todo: change later

// Load background music
const backgroundMusic = new Audio("sounds/bonus.mp3");  // change later
